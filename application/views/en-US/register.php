            ...
            <div class="col-md-6 col-sm-offset-3">
                ...
                <div class="divregister">
                    ...
                    <form class="form-horizontal" role="form" style="margin-top:20px;">
                      ...
                      <div class="form-group">
                        <div class="col-sm-6">
                          <label for="inputEmail3" class="control-label">Email đăng nhập
                                <span style="color: red;">(*)</span><br/>
                                 <span style="font-size:11px">Dùng để nhận thông báo từ spa </span>
                          </label>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                        <label for="inputname2" class=" control-label">Điện thoại<span style="color: red;">(*)</span><br/>
                        <span style="font-size:11px">Dùng để nhận thông báo từ spa </span>
                        </label>
