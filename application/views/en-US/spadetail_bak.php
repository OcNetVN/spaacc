                                                    ...
                                                    echo '<table class=" table table-striped table-hover wrap-product-lists" width="100%" border="0" cellspacing="0" cellpadding="5">';
                                                        ...
                                                        foreach($list_pro as $row_list_pro)
                                                        {
                                                            ...
                                                            if(count($listPromo) > 0)
                                                            {
                                                                ...
                                                                $savepercent=round($a);
                                                                echo '<td class="item-title"><a href="javascript:void(0);" onclick="showdetailpro(\''.$idsp.'\',\''.$listPromo[0]->PromotionId.'\');" data-toggle="modal" data-target="#serviceModal">'.$row_list_pro->Name.'</a></td>';
                                                                ...
                                                                echo '<td class="item-title"><a href="javascript:void(0);" onclick="showdetailpro(\''.$idsp.'\',\''.$promotionid.'\');" data-toggle="modal" data-target="#serviceModal">'.$row_list_pro->Name.'</a></td>';
