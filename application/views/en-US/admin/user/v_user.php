...
?>
 <head>
       ...
       <script type="text/javascript" src="<?php echo base_url('resources/scripts/jquery.number.js'); ?>"></script>
        ...
        <script type="text/javascript" src="<?php echo base_url('resources/scripts/admin/user.js'); ?>"></script>
    ...
    <body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
                ...
                <div class="content-box-content">
                    ...
                    <div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
                        ...
                        <div id="phuongthuc">
                            ...
                            <input type="button" class="button" id="themuser" value="Thêm user"/>
                        </div>
                        <div class="cpbody" id="khungtim" style="display: none;">
                            ...
                            <form id="form1" name="form1" method="post" action="">
                                  <table width="100%" border="0">
                                    ...
                                    <tr>
                                      <td>Tên đăng nhập</td>
                                      <td><input type="text" id="timtendn" class="text-input medium-input"/></td>
                                      <td>Họ và tên</td>
                                      <td>
                                    ...
                                    <tr>
                                         <td>Từ ngày</td>
                                         <td><input type="text" id="todate" class="text-input medium-input tcal"/></td>
                                         <td>Đến ngày</td>
                                         <td><input type="text" id="endate" class="text-input medium-input tcal"/></td>    
                                    </tr>
                                    <tr>
                                      <td><input class="button" type="button" id="button" value="Tim" onclick="searchuser(1);"/>
                ...
                <div id="divTBKQTim" style="margin-top: 10px; display: none;" class="notification success png_bg">
                    ...
                    <div class="cpbody" id="khunginsert" style="display: none;">
                        <form id="form1">
                              <table width="100%" border="0">
                                <tr>
                                  <td width="16%">Tên đăng nhập(Email) <span style="color:#F00;">(*)</span></td>
                                  <td width="38%">
                                    <input type="text" id="tendnthem" class="text-input medium-input"/><span id="err_tendn" style="color: red; font-weight: bold; display: no;"></span>
                                    <input id="useridthem" type="hidden" />
                                    <input id="objidthem" type="hidden" />
                                  </td>
                                  <td width="11%">Password<span style="color:#F00;">(*)</span></td>
                                  <td width="35%"><input type="password" id="passwordthem" class="text-input medium-input"/><span id="err_pass" style="color: red; font-weight: bold; display: no;"></span></td>
                                </tr>
                                <tr>
                                  <td>Họ tên<span style="color:#F00;">(*)</span></td>
                                  <td><input type="text" id="hotenthem" class="text-input medium-input"/><span id="err_hoten" style="color: red; font-weight: bold; display: no;"></span>
                                  
                                  </td>
                                  <td>Role</td>
                                  <td><select id="rolethem">
                                    <option value="0">Tất cả</option>
                                  </select></td>
                                </tr>
                                <tr>
                                  <td>Status</td>
                                  <td><select id="statusthem">
                                    <option value="0">Khoá</option>
                                    <option value="1">Hoạt động</option>
                                  </select></td>
                                  <td>Score</td>
                                  <td><input type="text" id="scorethem" class="text-input medium-input"/></td>
                                </tr>
                                <tr>
                                  <td>Object Group</td>
                                            ...
                                            <div class="content-box-content">    
                                                <div class="tab-content default-tab">
                                                    ...
                                                    <div class="form-group">
                                                      ...
                                                      <input type="button" class="btn btn-default" value="Upload" onclick="return doUpload1('<?php echo base_url('admin/user/UploadFile')  ?>');" />
                                ...
                                <tr>
                                  <td>&nbsp;</td>
                                  <td><input type="button" class="button" onclick="btnthem_user();" value="Thêm" />
                    ...
                    <div class="cpbody" id="khungedit" style="display: none;">
                        <form id="form2">
                              <table width="100%" border="0">
                                <tr>
                                  <td width="16%">Tên đăng nhập(Email) <span style="color:#F00;">(*)</span></td>
                                  <td width="38%"><input type="text" disabled="disabled" id="edit_tendn" class="text-input medium-input"/></span>
                                  <input id="edit_obj" type="hidden"/>
                                  <input id="edit_obj_user" type="hidden"/>
                                  <input id="edit_userid" type="hidden"/>
                                  </td>
                                  <td width="11%">Password mới</td>
                                  <td width="35%"><input type="password" id="passwordedit" class="text-input medium-input"/><span id="err_passedit" style="color: red; font-weight: bold; display: none;"></span></td>
                                </tr>
                                <tr>
                                  <td>Họ tên<span style="color:#F00;">(*)</span></td>
                                  <td><input type="text" id="hotenedit" class="text-input medium-input"/><span id="err_hotenedit" style="color: red; font-weight: bold; display: none;"></span></td>
                                  <td>Role</td>
                                  <td><select id="roleedit">
                                    <option value="0">Tất cả</option>
                                  </select></td>
                                </tr>
                                <tr>
                                  <td>Status</td>
                                  <td><select id="statusedit">
                                    <option value="0">Khoá</option>
                                    <option value="1">Hoạt động</option>
                                  </select></td>
                                  <td>Score</td>
                                  <td><input type="text" id="scoreedit" class="text-input medium-input"/></td>
                                </tr>
                                <tr>
                                  <td>Object Group</td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                    <!-- start up load hinh anh --> 
                                    <!--<div id="UploadHinhAnh_edit" class="class_ThemThanhCong_edit">   -->       
                                            <div class="content-box-content">    
                                                <div class="tab-content default-tab">
                                                    <form role="form" action="#" method="post" enctype="multipart/form-data" >
                                                    <div class="form-group">
                                                      ...
                                                      <input type="button" class="btn btn-default" value="Upload" onclick="return doUpload_edit1('<?php echo base_url('admin/user/UploadFile_edit')  ?>');" />
                                                      <input type="button" class="btn btn-default" value="Cancle" onclick="cancleUpload();"/>
                                                    </form>
                                                    <hr>
                                                    <div id="progress-group_edit">
                                                        ...
                                                        <!--<div class="progress_edit">
                                                          <div class="progress-bar_edit" style="width: 40%;">
                                                            Tên file:
                                                          </div>
                                                          <div class="progress-text_edit">
                                                              Tiến trình:
        ...
        <div style="display:none;width:800px;height:600px;" id="divxemuser" >
            <span>User name: </span><span id="showUserId"></span><br />
    ...
    <script id="ListFoundPRO" type="text/x-jquery-tmpl" > 
                            <tr>
                                ...
                                <td>                                        
                                     <a href="javascript:void(0);" onclick="suauser('${UserId}','${FullName}','${ObjectId}','${ObjectGroup}','${ObjectType}','${RoleId}','${Gender}');" title="Sửa"><img src="<?php echo base_url('resources/images/icons/pencil.png'); ?>" alt="Sửa" /></a>
                                     <a href="javascript:void(0);" onclick="xoauser('${UserId}','${ObjectId}');"  title="Xóa"><img src="<?php echo base_url('resources/images/icons/cross.png'); ?>" alt="Xóa" /></a> 
                                     <a href="javascript:void(0);" onclick="xemuser('${UserId}','${ObjectId}','${ObjectGroup}','${ObjectType}');"  title="Xem chi tiết"><img src="<?php echo base_url('resources/images/icons/show.png'); ?>" alt="Xem chi tiết" />
                                </td>
                            </tr>
                        </script> 
