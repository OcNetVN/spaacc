                ...
                <div class="content-box-content">           
                    <div class="tab-content default-tab" id="tab1">                      
                        ...
                        <table>
                            <tr>
                             ...
                             <tr>
                                ...
                                <td class="col_with"><input type="text" name="spaName" id="txt_NameProduct" class="class-input-text"></td>                                    <td class="lable_with"><label>Tên spa</label></td>
                                <td class="col_with"><input type="text" name="spaName" id="txt_NameSpa" class="class-input-text"></td>
                            </tr>
                     ...
                     <div  style="margin-left:370px;margin-bottom: 30px;"> 
                        ...
                        <form id="export" name="export" method="post" action="<?php echo base_url('admin/promotion/export_excel'); ?>">
                            <input class="button" style="margin-left:60px;" id="export" name="export" type="submit" value="Export Excel">
                        </form>
                    </div> 
            <div class="clear"></div>
               ...
               <script id="ShowSearchListPromo" type="text/x-jquery-tmpl" >        
                    <tr >
                            ...
                            <td>
                               ...
                               <b>Tên Spa:</b><span> ${spaName}</span><br />
                    ...
                    <div class="tab-content" id="tab2">
                        <form id="form_insert"> 
                            ...
                            <table width="100%" >
                                ...
                                <tr>
                                    <td colspan="2"><label>Chọn khuyến mãi đặc biệt</label><input type="checkbox"  id="checkpromotion"/></td>
                                </tr>
                                <tr>
                                    <td colspan="2">
    ...
    <div class="content-box-header" ><h3>Vui lòng chọn sản phẩm cho khuyến mãi</h3></div>          
        ...
        <!-- Nhập giá tổng  khuyến mãi -->
           <div id="divShowPromoTottal" style="display: none;">
                ...
                <span id="Total_PromotionTotal" style="display: none;margin-left: 55%;">
        ...
        <!-- End nhập giá tổng khuyến mãi -->             
            ...
            <div id="divShowListProduct">
               ...
               <!-- <span id="Total_PromotionDetail" >
                    <b>Tổng tiền:</b><input type="text" id="totalPromotionDetail" readonly="readonly" />
                </span>-->
                <br />
