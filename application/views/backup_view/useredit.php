                     ...
                     <div class="row">
                        <div class="col-md-6 col-sm-offset-3">
                            ...
                            <form class="form-horizontal" role="form" style="margin-top:20px;">
                              ...
                              <div class="form-group">
                                <label for="inputPass" class="col-sm-4 control-label">Mật khẩu <span style="color: red;">(*)</span></label>
                                <div class="col-sm-8">
                                  <input type="password" class="form-control" id="inputPass" placeholder="Nhập mật khẩu"><span id="err_pass" style="display: none; color: red;"></span>
                                </div>
                              </div>
                              <div class="form-group">
                                <label for="inputrePass" class="col-sm-4 control-label">Xác nhận mật khẩu <span style="color: red;">(*)</span></label>
                                <div class="col-sm-8">
                                  <input type="password" class="form-control" id="inputrePass" placeholder="Nhập lại mật khẩu"><span id="err_repass" style="display: none; color: red;"></span>
                                </div>
                              </div>
                              <div class="form-group">
                                <label for="inputtel" class="col-sm-4 control-label">Số ĐT <span style="color: red;">(*)</span></label>
                                <div class="col-sm-8">
                                  <input type="text" class="form-control" id="inputtel" placeholder="Nhập Số Điện Thoại"><span id="err_tel" style="color: red; display: none;"></span>
                                </div>
                              </div>
                              <div class="form-group">
                              ...
                              <!--Thong tin them-->
                              <div class="form-group" id="div_ex_info">
