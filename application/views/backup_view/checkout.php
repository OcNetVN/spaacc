    ...
    <div id="loadcontent1">
        ...
        <div class="tab-content">
                <div class="tab-pane active" id="pay-now">
            	   Bạn có tài khoản?  <a href="javascript:void(0);" data-toggle="modal" data-target="#loginModal" style="font-weight:bold;">Đăng nhập</a>
				  
                </div>
                <div class="tab-pane" id="pay-venue"> <!--đăng kí nhanh-->
                    <div class="col-md-6 col-sm-offset-3">
                        <h1 class="title-page" style="text-align:center;">Đặt chổ nhanh</h1>
