...
<head>
    ...
    <script src="<?php echo base_url('resources/scripts/jquery.number.js'); ?>"></script>
	 ...
	 <script src="<?php echo base_url('resources/front/js/analytic.js'); ?>"></script>
    <!-- bxSlider CSS file -->
    ...
    <!-- InstanceBeginEditable name="Main Content" -->
            ...
            foreach($list_info_session as $row_info)
            {
                ...
                echo '<div class="wrap-table">';
                    ...
                    foreach($row_info['list_pro'] as $row_pro)
                    {
                        ...
                        echo "<td>".$stt."</td>";
                        echo '<td><a href="javascript:void(0);" data-toggle="modal" data-target="#serviceModal">'.$row_pro->Name.'</a></td>';
                        ...
                        echo '</td>';
                        echo '<td><button type="button" class="btn btn-danger" onclick="deletesubcart(\''.$row_pro->ProductID.'\',\''.$row_info['spa']->spaID.'\',\''.$stt.'\');">Remove</button></td>';
        ...
        ?>
          ...
          <div id="divcontentnull" style="display: none;"><h2 style="margin: 30px;">Không có dữ liệu, vui lòng reload lại trang</h2></div>
            <button type="button" id="btnReload" class="btn btn-default pull-left" style="display: none;" onclick="parent.location='checkout1'">Reload</button>
            <button type="submit" id="btncontinue" class="btn btn-default pull-right" onClick="gotostep2();">Continue</button>
        </div>    
<!-- Modal -->
                                    ...
                                    <div id="wrap-add-comment-popup" style="display: none" class="wrap-add-comment">
                                        <form role="form">
                                            <div class="form-group">
                                                <label>Ná»™i dung bÃ¬nh luáº­n</label>
                                                <textarea class="form-control" rows="3"></textarea>
                                            </div>
                                            <button type="submit" class="btn btn-default pull-right">Gá»­i bÃ¬nh luáº­n</button>
                                        </form>
                                    </div>  
