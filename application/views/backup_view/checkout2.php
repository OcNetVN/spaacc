    ...
    <div id="loadcontent1">
          ...
          <?php
            ...
            foreach($Payment as $row_pay)
            {
                if($i==0)
                    ...
                    $classactive="";
                echo '<li '.$classactive.'><a href="#p_'.$row_pay->StrValue2.'" role="tab" data-toggle="tab">'.$row_pay->StrValue1.'</a></li>';
                $i++;
            }
            ?>
        ...
        foreach($Payment as $row_pay)
        {
            if($row_pay->CommonId=="01")
            {
                ...
                echo '</label> <br> ' .$row_pay->StrValue3.'   ';
                echo '<select id="SelCardTypeFor123Pay" name="SelCardTypeFor123Pay">
				   <option value="123PAY" checked> Domestic ATM</option>
				   <option value="123PCC">VISA / Master / JCB</option>
				</select>';
                echo '</div>';
                }
            else
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><button type="submit" class="btn btn-default" onClick="parent.location='checkout1'">Back</button></td>
            <td><button type="submit" class="btn btn-default pull-right" onClick="gotostep3();">Continue</button></td>
          </tr>
        </table>
       </div> 
       <!--step 3-->
