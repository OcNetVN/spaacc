...
?>
 <head>
        ...
        <script type="text/javascript" src="<?php echo base_url('resources/scripts/admin/producttype.js'); ?>"></script>
            ...
            <div class="content-box" style="display:block;"><!-- Start Content Box -->
                ...
                <div class="content-box-header">
                    ...
                    <ul class="content-box-tabs">
                        <li><a href="#tab1" id="prlist" class="default-tab">Tìm loại sản phẩm</a></li> <!-- href must be unique and match the id of target div -->
                        <li><a href="#tab2" id="prinsert">Thêm loại sản phẩm</a></li>
                    </ul>
                    <div class="clear"></div>
                       ...
                       Tìm được 0 mẫu tin!
                        ...
                        <div id="pannel_suasanpham" style="display: none;">    
                            ...
                            <fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
                                <p>
                                    <label>Cấp</label>              
                                    <select id="capsua" class="small-input" disabled="disabled">
                                    </select> 
                                    <input type="hidden" id="idsua" name="idsua" value="" />
                                </p>
                                <p id="ploaichasua" style="display: none;">
                                    <label>Loại sản phẩm cha</label>              
                                    <select id="loaispchasua" class="small-input" disabled="disabled">
                                        <option value="2">Loại cha</option>
                                    </select> 
                                </p>
                                <p id="psualoai" style="display: none;">
                                    <label>Tên loại cha</label>
                                    <input class="text-input medium-input" disabled="disabled" type="text" id="tenloaichasua" name="tenloaichasua" />
                                </p>
                                <p>
                    ...
                    <div class="tab-content" id="tab2">
                        ...
                        <form id="form_insert">
                            ...
                            <fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
                                <p>
                                    <label>Cấp </label>              
                                    <select id="cap" class="small-input">
                                        <option id="op_cap1" value="2">Loại cha</option>
                                        <option id="op_cap2" value="1">Loại con</option>
                                    </select> 
                                </p>
                                <!--<p id="ploai">
                                    <label>Ma loai san pham</label>              
                                    <input id="idloaisanpham" type="text" disabled="disabled" readonly="readonly" class="text-input small-input" value=""/>
                                </p>-->
                                <p id="ploaicha" style="display: none;">
                                    <label>Loại sản phẩm cấp 1</label>              
                                    <select id="loaispcha" class="small-input">
                                        <?php 
                                        $i=0;
                                            foreach($loaicha as $row=>$value)
                                           {
                                                if($i==0)
                                                    echo '<option value="'.$row.'" selected="selected">'.$value.'</option>';
                                                else
                                ...
                                <p>
                                    ...
                                    <span id="err_tenen" style="display: none; color: red; font-weight: bold;">Không được rỗng</span>
                                </p>
                                <p>
                                    <label>Trạng thái</label>              
    ...
    <script id="ListFoundPRO" type="text/x-jquery-tmpl" > 
                            <tr>
                                ...
                                <td>                                        
                                     <a href="javascript:void(0);" onclick="loadsualoai('${CommonId}');" title="Sua"><img src="<?php echo base_url('resources/images/icons/pencil.png'); ?>" alt="Sua" /></a>
                                     <a href="javascript:void(0);" onclick="DeleteProduct('${CommonId}',0);"  title="Xóa"><img src="<?php echo base_url('resources/images/icons/cross.png'); ?>" alt="Xóa" /></a> 
                                     <a href="javascript:void(0);" onclick="searchProductsCon('${CommonId}',1);"  title="Show loai con"><img src="<?php echo base_url('resources/images/icons/show.png'); ?>" alt="Chi tiet" />
                                </td>
                            </tr>
                        </script> 
     <!--product type con-->                   
    <script id="ListFoundPRO1" type="text/x-jquery-tmpl" > 
                            <tr>
                                ...
                                <td>                                        
                                     <a href="javascript:void(0);" onclick="loadsualoai('${CommonId}');" title="Sua"><img src="<?php echo base_url('resources/images/icons/pencil.png'); ?>" alt="Sua" /></a>
                                     <a href="javascript:void(0);" onclick="DeleteProduct('${CommonId}',1);"  title="Xóa"><img src="<?php echo base_url('resources/images/icons/cross.png'); ?>" alt="Xóa" /></a> 
