...
?>
 <head>
        ...
        <script type="text/javascript" src="<?php echo base_url('resources/scripts/admin/mangemenu.js'); ?>"></script>
...
<body>
    ...
    <div id="main-content"> <!-- Main Content Section with everything -->
        <div class="clear"></div> <!-- End .clear -->
            <div class="content-box" style="display:block;"><!-- Start Content Box -->
                <div class="content-box-header">
                    ...
                    <ul class="content-box-tabs">
                        <li><a href="#tab1" id="prlist" class="default-tab">Tra cứu menu</a></li>
                    </ul>
                    <div class="clear"></div>
                       ...
                       <div class="cpbody" style="" >
                        <table>
                            <tr>
                                ...
                                <td class="lable_with"><label>Tên menu</label></td>
                                <td class="col_with"><input type="text" name="menuName" id="txtmenuName" class="class-input-text"></td>
                            </tr>
                             <tr>
                                <td class="lable_with"><label>Mô tả</label></td>
                                <td class="col_with"><input type="text" name="spaName" id="txt_Notes" class="class-input-text"></td>      
                            </tr>
                           
                        </table>
                    </div> 
                     <div  style="margin-left:370px;margin-bottom: 30px;"> 
                        <input type="button" class="btn " value="Search" onclick="searchMenu(1);"  style="width:100px;height:30px;" >
           ...
           <div class="divSearchListMenu">
                    <table id="tbSearchMenu" >
                        <thead>
                            <tr>
                                <th>STT</th>
                                <th>Mã menu</th>
               ...
               <script id="ShowSearchListMenu" type="text/x-jquery-tmpl" >        
                    <tr id="trmenu${MenuId}">
                            <td>${STT}</td>
                            ...
                            <td>
                               ...
                               <b>Ngày tạo:</b><span> ${CreatedDated}</span><br />
                               <b>Người tạo:</b><span>${CreatedBy}</span><br />
                            </td>
                            <td class="">
                              <a href="javascript:void(0)"  name='btn_del' id='btn_del' onclick="EditMenu('${MenuId}');">
...
<div id="DivEditMenu" style="display:none;margin-left: 50px;">
<h2>Chỉnh sửa tên menu</h2>
    <form id="form_Edit"> 
        <fieldset> 
            <table width="100%" >
                <tr>
                    <td><label>Mã Menu</label></td>              
                    <td><span id="spanMenuID"></span></td>
                </tr>
                <tr>
                    <td><label>Tên Menu</label> </td>
                    <td><input id="txt_MenuName" type="text" class="text-input medium-input" /></td>
                </tr>
                <tr>
                    <td><label>URL menu</label></td>
                    <td><span id="spanUrl"></span></td>
                </tr>
                <tr>
                    <td><label>Mô tả</label></td>
                    <td><span id="spanNotes"></span></td>
                </tr>
            </table>
        </fieldset>
            ...
            <div id="divmessageError" class="notification error png_bg ThemThatBai" style="display: none;">
                <a href="#" class="close"><img src="<?php echo base_url('resources/images/icons/cross_grey_small.png'); ?>" title="Close this notification" alt="close" /></a>
                <div>
                    Cập nhật tên menu không thành công !
                </div>
            </div>
             <input type="button" value="Cập nhật" id="btn_CapNhat" onclick="LuuCapNhatMenu();" />
             <input  type="button" value="Đóng" id="btn_CloseMenu" onclick="CloseMenu();"/>
            <div class="clear"></div><!-- End .clear -->  
    </form>
</div> 
<!-------------END THEM SAN PHAM--------------->
