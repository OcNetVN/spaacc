...
else
{
 ...
 <head>
        ...
        <script type="text/javascript" src="<?php echo base_url('resources/scripts/admin/promotionedit.js'); ?>"></script>
                                ...
                                <tr>
                                    <td>
                                         <p>
                                            ...
                                            <input class="text-input small-input tcal" type="text" id="BeginTime" name="ValidTimeFrom" value="<?php echo $promo[0]->BeginDateTime; ?>" />
                                        </p>
                                    </td>
                                    <td>
                                        <p>
                                            <label>Kết thúc khuyến mãi</label>
                                            <input class="text-input small-input tcal" type="text" id="EndTime" name="ValidTimeTo" value="<?php echo $promo[0]->EndDateTime; ?>"/>
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2"><label>Chọn khuyến mãi đặc biệt</label>
                                       <?php if($promo[0]->PromotionType == "KMDB") {  ?>
                                                <input type="checkbox"  id="checkpromotion" checked="checked"/>
                                    <?php   }else{   ?>
                                               <input type="checkbox"  id="checkpromotion" />
                                    <?php   }?>
    ...
    <div class="content-box-header" ><h3>Vui lòng chọn sản phẩm cho khuyến mãi</h3></div>          
        <div class="content-box-content">    
                    ...
                    <table>
                        <tr>
                            <td>
                                ...
                                <p><input  type="radio" id="RaPromotion"  name="Promotion" value="PromotionTotal" <?php echo (($listpro['total'] != '0.00')?"checked":"")?>/>Nhập giá trị tổng cho khuyến mãi</p>
                                <p><input  type="radio" id="RaPromotionDetail" name="Promotion" value="PromotionDetail"  <?php echo (($listpro['total'] == '0.00')?"checked":"")?>/>Nhập giá trị chi tiết cho khuyến mãi</p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td style="display: none;" id="tdChooseProductSpa">
                                 ...
                                 <div class="divSpaDetail">
                                     ...
                                     <b>Tên sản phẩm:</b><span id="spanPrdouctNameChon"></span><br/>
                                      <p id="HiddenSelected"><b>Giá tiền mới nhất SP:</b><span id="spaProductPrice"></span></p> 
                                     <!--<a href="javascript:void(0);" onclick="ShowSpaDetailTab2()">xem chi tiết</a>
                                     <div id="divShowChiTietSpa" class="divSpaDetail" style="display: none;" ></div>-->
                                 </div>
                                 <br />
                        ...
                        <tr id="tr_Percent_Count_total" style="display: none;">
                            <td>
                                <label>Phần trăm khuyến mãi</label>
                                <input id="txtPromotionPrice_total" type="text" class="text-input small-input" value="0" readonly="readonly" />
                            </td>
                            <td>
                                <label>Số lượng</label>
                                <input id="txtQuantity_total" type="text" class="text-input small-input" />
                            </td>
                      </tr>
                    </table>
                     <p id="p_PromoPro_dis" >
           ...
           <div id="divShowPromoTottal" style="display: none;">
                ...
                <span id="Total_PromotionTotal" style="display: none;margin-left: 70%;">
                    <b>Tổng tiền:</b><input type="text" id="totalPromotion"  />
                </span>
        ...
        <!-- End nhập giá tổng khuyến mãi --> 
            ...
            <div id="divShowListProduct">
                ...
                <table id="tbShowListProductPromo" style="">
                 ...
                 <input type="button" value="Cập nhật" id="btn_CapNhat" onclick="LuuCapNhatPromo();" />
            </div>
        </div>
    </div>
</div>
...
<div style="display:none;width:800px;height:600px;" id="divSearchSpaTab2" >
        ...
        <table class="tableborder table-fill" id="panelDataSPATab2">
            <thead>
                <tr>
                    <th>STT</th>
                    <th>Mã SPA</th>
