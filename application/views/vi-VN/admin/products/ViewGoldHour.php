...
?>
 <head>
        ...
        <script type="text/javascript" src="<?php echo base_url('resources/scripts/admin/goldhour.js'); ?>"></script>
           ...
           <div class="divSearchListPromotion">
               ...
               <script id="ShowSearchListPromo" type="text/x-jquery-tmpl" >        
                    <tr >
                            ...
                            <td class="">
                              <a href="<?php echo base_url('admin/goldhour/edit/${PromotionId}/${ProductID}');?>"  name='btn_edit' id='btn_edit'>
                            ...
                            <table width="100%" >
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input class="text-input small-input" value="<?php echo date('Y-m-d');?>" readonly="readonly"   type="text" id="BeginTime" name="ValidTimeFrom" />
                                        <input type="text" value="" id="beginhours" name="basic_example_2" class="text-input small-input"/>
                    
                                    </td>
                                    <td>
                                        <label>Kết thúc khuyến mãi</label>
                                        <input class="text-input small-input " value="<?php echo date('Y-m-d');?>" readonly="readonly"  type="text" id="EndTime" name="ValidTimeTo" />
                                        <input type="text" value="" id="endhours" name="basic_example_2" class="text-input small-input"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
        ...
        <div class="content-box-content">    
            <div class="tab-content default-tab">
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                 ...
                                 <a href="javascript:void(0);" id="choose_spa" class="button" onclick="ChonSpaThemMoi();" >Chọn spa</a><br />
                            ...
                            <td style="display: none;" id="tdChooseProductSpa">
                                 ...
                                 <a href="javascript:void(0);" class="button" id="ChooseSProduct" onclick="ChonSpaProductThemMoi();" >Chọn sản phẩm</a><br />
                                 <div class="divSpaDetail">
                                     <b>Mã sản phẩm:</b> <span id="spanProductSpaChon" class="spanSpaChonTab2"></span> <br />
                                     <b>Tên sản phẩm:</b><span id="spanPrdouctNameChon"></span>
                        ...
                        <!--<tr id="tr_Percent_Count_total" style="display: none;">
                            <td>
                                ...
                                <input id="txtPromotionPrice_total" type="text" class="text-input small-input" />
                            </td>
                            <td>
                                <label>Số lượng</label>
                                <input id="txtQuantity_total" type="text" class="text-input small-input" value="1" readonly="readonly"/>
                            </td>
                        </tr>-->
                    </table>
                     <p id="p_PromoPro_dis" >
                ...
                <div id="divAddmessageSucess" class="notification success png_bg ThemThanhCong" style="display: none;">
                    <a href="#" class="close"><img src="<?php echo base_url('resources/images/icons/cross_grey_small.png'); ?>" title="Close this notification " alt="close" /></a>
                    <div>
                       Thêm sản phẩm khuyến mãi của spa thành công !
                    </div>
                </div>
            ...
            <div id="divAddmessageError" class="notification error png_bg ThemThatBai" style="display: none;">
                <a href="#" class="close"><img src="<?php echo base_url('resources/images/icons/cross_grey_small.png'); ?>" title="Close this notification" alt="close" /></a>
                <div>
                     Thêm sản phẩm khuyến mãi của spa không thành công !
                </div>
            </div>
        <!-- Danh sách tổng  khuyến mãi -->
           <div id="divShowPromoTottal" style="display: none;">
                <table id="tbShowListProductPromoTotal" >
                    <thead>
                        <tr>
                            <th>STT</th>
                            <th>Mã sản phẩm</th>
                ...
                <span id="Total_PromotionTotal" style="display: none;margin-left: 55%;margin-bottom: 4%;margin-top: 4%;">
                    <b>Tổng tiền:</b><input type="text" id="totalPromotion"  value="0"/>
                </span>
                
               <br /> 
               <div id="divmessageSucess_total" class="notification success png_bg ThemThanhCong" style="display: none;">
                    <a href="#" class="close"><img src="<?php echo base_url('resources/images/icons/cross_grey_small.png'); ?>" title="Close this notification " alt="close" /></a>
                    <div>
            ...
            <div id="divmessageError_total" class="notification error png_bg ThemThatBai" style="display: none;">
                <a href="#" class="close"><img src="<?php echo base_url('resources/images/icons/cross_grey_small.png'); ?>" title="Close this notification" alt="close" /></a>
                <div>
                    Cập nhật sản phẩm khuyến mãi của spa không thành công !
                </div>
            </div>
                <input type="button" value="Cập nhật" id="btn_CapNhatTotal" onclick="LuuCapNhatPromoTotal();" />
           </div>   
           <!-- End nhập giá tổng khuyến mãi -->     
            <!-- Danh sách giá chi tiết cho từng khuyến mãi -->
            ...
            <!-- End danh sách giá chi tiết cho từng khuyến mãi -->
        </div>
    </div>
</div>
...
<div id="UploadHinhAnh" class="class_ThemThanhCong" style="display: none;">                
    <div class="content-box-header" ><h3>Vui lòng chọn hình ảnh cho khuyến mãi</h3></div>          
       ...
       <p><input type="button" value="Tiếp tục thêm mới giờ vàng" onclick="ResetThemPromotion()"/></p>                                                    
