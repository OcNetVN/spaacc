...
<header>
    ...
    <div class="full-bar wrap-banner" style="background-image:url(<?php echo base_url('resources/front/images/banner1.jpg'); ?>);">
        <div class="wrap-quick-booking">
            <div class="container">
                <h2 class="banner-title">HỆ THỐNG ĐẶT CHỖ SPA & BEAUTY SALON ĐẦU TIÊN TẠI VIỆT NAM<br />VỚI HƠN 1000 DỊCH VỤ ĐƯỢC CẬP NHẬT MỖI NGÀY</h2>
    ...
    <!-- InstanceBeginEditable name="Main Content" -->
        ...
        <h1 class="title">NHANH TAY CHỌN DỊCH VU KHUYẾN MÃI LÊN TỚI 60%</h1>
        ...
        <div class="row">
            <div class="col-md-12 wrap-products">
                ...
                ?>
                                <div class="wrap-product shadow-box">
                                    <a href="javascript:void(0)"><span class="spanbook" onclick="showdetailpro('<?php echo $idsp;?>','<?php echo $promotionid ?>');" data-toggle="modal" data-target="#serviceModal">
            ...
            <div class="col-xs-7">
                <div class="wrap-likebox">
                   ...
                   <div style="margin-top:10px;">
                        <iframe width="650" height="260" src="<?php echo $linkyoutube; ?>" frameborder="0" allowfullscreen></iframe>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Sản phẩm khuyến mãi</h4>
      </div>
