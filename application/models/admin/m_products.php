        ...
        public function __construct()
      {
        ...
        public function Them_Moi_Product()
        {
            ...
            try
            {
                ...
                $this->db->query($sql);
                $slq_update = "UPDATE `price` SET `Status`='0' WHERE `ProductID`= '$proID' AND `Status`='1'";
                $this->db->query($slq_update);
                try{
                    $sql1 = "INSERT INTO `price`(`ProductID`,`Price`,`CreatedBy`,`CreatedDate`,`Status`) VALUES('$proID','$Price','$createdby',NOW(),'1');";
                    $this->db->query($sql1);    
                }
                catch(exception $oo)
                {
...
//             }
            ...
            try
            {
                ...
                //$sql = "UPDATE `products` SET `SpaID`='$SpaID',`Name`='$proName',`Description`='$desciption',`Status`='$Status',`ProductType`='$proType',`CurrentVouchers`='$CurrentVouchers',`Duration`='$Duration',`MaxProductatOnce`='$MaxProductatOnce',`ValidTimeFrom`='$ValidTimeFrom',`ValidTimeTo`='$ValidTimeTo',`Policy`='$policy',`Restriction`='$Restriction',`Tips`='$Tips',`ModifiedDate` = NOW(),`ModifiedBy` = '$modifedby', `ProductID`='$proID' WHERE `ProductID`='$proIDCheck'";
                $this->db->query($sql);
                $slq_update = "UPDATE `price` SET `Status`='0' WHERE `ProductID`= '$proID' AND `Status`='1'";
                $this->db->query($slq_update);
                try{
                    $sql1 = "INSERT INTO `price`(`ProductID`,`Price`,`CreatedBy`,`CreatedDate`,`Status`) VALUES('$proID','$Price','$modifedby',NOW(),'1');";
                    $this->db->query($sql1);    
                }
                catch(exception $oo)
                {
         ...
         public function getProducctID()
        {
            ...
            $sql="SELECT `ProductID` FROM `products` WHERE LEFT(`ProductID`,10) = '".$id."' order by `ProductID` ";
