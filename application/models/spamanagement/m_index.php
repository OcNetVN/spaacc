                ...
                for($i=0; $i<count($arr1); $i++)
                {
                    ...
                    if(count($arr3)> 0)
                    {
                        for($j=0; $j<count($arr3); $j++)   
                        {
                            ...
                            $str=$str ."<a href=\"javascript:void(0)\"><span class=\"spanbook\" data-toggle=\"modal\" data-target=\"#serviceModal\" onclick=\"showdetailpro('".$masp."');\" >";
...
//                                if($j == 1)
                    ...
                    if(count($arr3)> 0)
                    {
                        for($j=0; $j<count($arr3); $j++)   
                        {
                            ...
                            $str=$str ."<div class=\"box-on-menu \">";
                            $str=$str ."<a href=\"javascript:void(0)\"><span class=\"spanbook\" data-target=\"#serviceModal\" data-toggle=\"modal\" onclick=\"showdetailpro('".$masp."');\" >";
                            //$str=$str .$arr3[$j]->Description;
                            $sql4 ="SELECT * FROM `links` WHERE `ObjectIDD`='$masp' ORDER BY `UploadedDate` DESC LIMIT 1";
                            $links = $this->db->query($sql4)->result();
                            $arr4 = (array)$links;
