...
class Spaother extends CI_Controller
{
       ...
       function __construct()
       {
            ...
            $this->load->Model('admin/spaothermodel');
            //$this->load->Model('admin/spaproductype');
        }
        
        public function getspainfo()
        {
            $res= $this->spaothermodel->getspainfo();
            echo json_encode($res);
        }
        
        public function updatespafaclity(){
            
            $res= $this->spaothermodel->updatespafaclity();
            echo json_encode($res);
        }
        
        public function updatespatype(){
            $res= $this->spaothermodel->updatespatype();
            echo json_encode($res);
        }
        
        public function update_location(){
            $res= $this->spautilmodel->update_location();
            echo json_encode($res);
        }
     ...
     public function searchlocation(){
         ...
         if($ckq == true)
         {
           $req = $this->spautilmodel->ajax_location();
         }
        ...
        public function index(){
            ...
            {
                $arr_spa_Facility = $this->spaothermodel->get_Spa_Facility();
                $arr_Spa_Type     = $this->spaothermodel->get_Spa_Type();
                $this->load->view($lang.'/admin/spa/ViewSpaFacilityAn', array('list_spaFac'=> $arr_spa_Facility,'list_spatype'     =>$arr_Spa_Type));
            }
            else{
        ...
        if($this->CheckQuyen(6))
            {
               ...
               $this->load->view('/admin/spa/ViewEditSpa', array('spa' => $spa, 'listimage' => $ListImage, 'listproduct' => $ListProduct,"listtime"=>$ListTime,"productypelist"=>$productType)); 
            }
        else{
