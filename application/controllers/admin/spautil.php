...
class Spautil extends CI_Controller
{
       ...
       function __construct()
       {
            ...
            $this->load->Model('admin/spautilmodel');
            //$this->load->Model('admin/spaproductype');
        }
        
        public function getspainfo()
        {
            $res= $this->spautilmodel->getspainfo();
            echo json_encode($res);
        }
        
        public function updatespafaclity(){
            
            $res= $this->spautilmodel->updatespafaclity();
            echo json_encode($res);
        }
        
        public function updatespatype(){
            $res= $this->spautilmodel->updatespatype();
            echo json_encode($res);
        }
     ...
     public function searchlocation(){
        ...
        public function index(){
            ...
            {
                $arr_spa_Facility = $this->spautilmodel->get_Spa_Facility();
                $arr_Spa_Type     = $this->spautilmodel->get_Spa_Type();
                $this->load->view($lang.'/admin/spa/ViewSpautil', array('list_spaFac'=> $arr_spa_Facility,'list_spatype'     =>$arr_Spa_Type));
            }
            else{
