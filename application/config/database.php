...
$db['default']['password'] = '';
$db['default']['database'] = 'spabooking';*/
...
$db['thebooking']['pconnect'] = TRUE;
$db['thebooking']['db_debug'] = TRUE;
$db['thebooking']['cache_on'] = FALSE;
$db['thebooking']['cachedir'] = '';
$db['thebooking']['char_set'] = 'utf8';
$db['thebooking']['dbcollat'] = 'utf8_general_ci';
$db['thebooking']['swap_pre'] = '';
$db['thebooking']['autoinit'] = TRUE;
$db['thebooking']['stricton'] = FALSE;
$db['thebooking']['dbdriver'] = 'mysqli';
